...
- [Build Scripts Reference](#build-scripts-reference)
  - [build-shopify.mjs](#build-shopifymjs)
  - [upload-to-shopify.mjs](#upload-to-shopifymjs)
  - [create-section.mjs](#create-sectionmjs)
  - [validate-theme.mjs](#validate-thememjs)
  - [ai-optimize.mjs](#ai-optimizemjs)
  - [deploy-edge.mjs](#deploy-edgemjs)
  - [migrate-secrets.js](#migrate-secretsjs)
  - [sync-branches.sh](#sync-branchessh)
- [Deployment](#deployment)
- [Troubleshooting](#troubleshooting)
- [Undocumented Features & Areas Requiring Deeper Explanation](#undocumented-features--areas-requiring-deeper-explanation)
  - [Advanced Features Requiring Setup](#️-advanced-features-requiring-setup)
  - [Partially Documented Components](#-partially-documented-components)
  - [Missing Documentation](#-missing-documentation)
  - [Recommended Workflow Enhancements](#-recommended-workflow-enhancements)
  - [Customization Tips by Use Case](#-customization-tips-by-use-case)
...
│   └── (Generated by build process - not tracked in Git)
...
├── src/                       # Source code (React app & server)
...
│       │   └── personalization.js # OpenAI product recommendations
│       ├── auth/             # Authentication
...
│       ├── secrets.js        # Secret management interface
│       ├── secrets_aws.js    # AWS Secrets Manager integration
│       ├── secrets_gcp.js    # GCP Secret Manager integration
│       └── tokenManager.js   # OAuth token management
├── scripts/                   # Build and deployment scripts
│   ├── ai-optimize.mjs       # AI-powered bundle optimization
│   ├── build-shopify.mjs     # Build for Shopify deployment
│   ├── create-section.mjs    # Generate Liquid sections
│   ├── deploy-edge.mjs       # Deploy to Cloudflare Workers
│   ├── migrate-secrets.js    # Migrate secrets to cloud providers
│   ├── optimize-bundle.mjs   # Bundle size optimization
│   ├── sync-branches.sh      # Branch synchronization script
...
**What it uploads:**
- `dist/assets/torqued-dashboard.js` → `assets/torqued-dashboard.js`
- `dist/assets/torqued-dashboard.css` → `assets/torqued-dashboard.css`
...
**What it checks:**
- ✓ Required directories exist (config, layout, locales, sections, templates)
- ✓ Required files present (settings_schema.json, theme.liquid, en.default.json)
- ✓ JSON files are valid
- ✓ Theme has theme_info in settings_schema.json
- ℹ Template and section counts
...
### ⚠️ Advanced Features Requiring Setup
